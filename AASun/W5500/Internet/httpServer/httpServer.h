...
// AASun configuration:
// Borrows _USE_FLASH_ for MFS web content access
#define		_USE_FLASH_
#include	"aa.h"
#include	"mfs.h"
#define		printf			aaPrintf
#define		snprintf		aaSnPrintf
...
#define M_INITIAL_WEBPAGE			"/index.html"
#define MOBILE_INITIAL_WEBPAGE		"/index.html"
...
typedef struct _st_http_socket
{
	...
	StorageType		storage_type; // Storage type; Code flash, SDcard, Data flash ...

#ifdef _USE_FLASH_
    mfsFile_t       mfsFile ;	// Every socket can use 1 file
#endif
}st_http_socket;
